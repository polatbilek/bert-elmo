...
python3 create_pretraining_data.py   --input_file=$BERT_BASE_DIR/turkish_wiki_set.txt   --output_file=/tmp/tf_examples.tfrecord   --vocab_file=$BERT_BASE_DIR/turkish_wiki_vocab.txt   --do_lower_case=True   --max_seq_length=96   --max_predictions_per_seq=15   --masked_lm_prob=0.15   --random_seed=12345   --dupe_factor=5
